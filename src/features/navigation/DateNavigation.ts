...
export class DateNavigation {
  ...
  public showDateContextMenu(event: MouseEvent, clickedDate: Date): void {
    ...
    const viewOptions = [
      { view: context.isNarrow ? 'timeGrid3Days' : 'dayGridMonth', label: t('ui.navigation.viewMonth') },
      { view: context.isNarrow ? 'timeGrid3Days' : 'timeGridWeek', label: t('ui.navigation.viewWeek') },
