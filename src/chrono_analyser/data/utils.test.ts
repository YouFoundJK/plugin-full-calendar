...
import { getRecurringInstances, calculateRecurringInstancesInDateRange, getRruleInstances, calculateRruleInstancesInDateRange } from './utils';
  ...
  describe('rrule events - skipDates handling', () => {
    ...
    describe('getRruleInstances', () => {
      it('should return all instances when skipDates is empty', () => {
        ...
        const instances = getRruleInstances(
          record,
          new Date('2023-11-01'),
          new Date('2023-11-10')
        );
