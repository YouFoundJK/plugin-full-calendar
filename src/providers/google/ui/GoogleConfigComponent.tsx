    ...
    if (view === 'account-select' && accountListRef.current) {
      ...
      accounts.forEach(account => {
        new Setting(container)
          ...
          .addButton(button =>
            button.setButtonText(t('google.buttons.selectCalendars')).onClick(() => handleSelectAccount(account))
          );
      });
  ...
  if (view === 'calendar-select') {
    return (
      <div>
        <div className="setting-item setting-item-heading">
          <div className="setting-item-info">
            <div className="setting-item-name">{t('google.selectCalendars.title', { email: selectedAccount?.email })}</div>
        ...
        <div className="setting-item">
          <div className="setting-item-control">
            <button onClick={() => setView('account-select')}>{t('google.buttons.backToAccounts')}</button>
            <button
              className="mod-cta"
