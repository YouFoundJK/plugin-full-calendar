...
const FullNoteDirectorySetting: React.FC<{ source: Partial<import('../../types').CalendarInfo> }> = ({ source }) => {
...
export class FullNoteProvider implements CalendarProvider<FullNoteProviderConfig> {
  ...
  getSettingsRowComponent(): FCReactComponent<{ source: Partial<import('../../types').CalendarInfo> }> {
