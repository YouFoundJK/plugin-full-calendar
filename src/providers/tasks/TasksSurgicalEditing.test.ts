...
describe('TasksPluginProvider - Surgical Editing', () => {
  ...
  describe('_extractExtraData', () => {
    it('should extract links and comments from task line', () => {
      const originalLine =
        '- [ ] Review PR #42 📅 2024-01-15 [PR Link](http://example.com) #urgent';
    ...
    it('should extract user comments after task metadata', () => {
      const originalLine =
        '- [x] Meeting with team ⏳ 2024-08-15 🛫 2024-08-10 Additional notes here';
      const taskData: OFCEvent = {
        type: 'single',
...
More content`;
    ...
    it('should preserve multiple types of extra data', async () => {
      ...
      const originalLine =
        '- [ ] Meeting ⏳ 2024-01-15 🛫 2024-01-14 [zoom](link) #work extra notes';
