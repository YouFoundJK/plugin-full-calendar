...
describe('TasksPluginProvider', () => {
  ...
  describe('read-only enforcement', () => {
    ...
    it('should throw error when trying to create instance override', async () => {
      ...
      await expect(provider.createInstanceOverride(masterEvent, instanceDate, newEventData)).rejects.toThrow(
        'TasksPluginProvider is read-only. Cannot create instance overrides.'
      );
    });
  });
