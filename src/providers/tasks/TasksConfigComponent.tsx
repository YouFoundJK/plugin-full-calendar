  ...
  return (
    <div className="tasks-provider-config">
      ...
      <form onSubmit={handleSubmit}>
        <div className="setting-item">
          <div className="setting-item-info">
            <div className="setting-item-name">{t('settings.calendars.tasks.calendarName.label')}</div>
            <div className="setting-item-description">{t('settings.calendars.tasks.calendarName.description')}</div>
          </div>
