      ...
      <div className="setting-item">
        <div className="setting-item-info">
          ...
          <div className="setting-item-description">
            This provider automatically reads your existing Obsidian Tasks plugin settings.
            All tasks with due dates will be displayed on the calendar as read-only events.
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="setting-item">
          <div className="setting-item-info">
            ...
            <div className="setting-item-description">
              Tasks can be viewed but not modified through the calendar interface.
              To edit tasks, use the Tasks plugin or modify your notes directly.
            </div>
          </div>
        </div>
