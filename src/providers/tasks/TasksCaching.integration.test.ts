...
Another regular line`;
      ...
      const completedDatedEvent = datedEvents.find(([event]) => event.title === 'Completed dated task');
      ...
      const completedUndatedTask = undatedTasks.find(task => task.title === 'Completed undated task');
