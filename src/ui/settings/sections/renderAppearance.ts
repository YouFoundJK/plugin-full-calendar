...
export function renderAppearanceSettings(
  ...
  new Setting(containerEl)
    ...
    .addDropdown(dropdown => {
      ...
      dropdown.addOption('[0,6]', t('settings.appearance.dayVisibility.hiddenDays.options.hideWeekends'));
      dropdown.addOption('[0]', t('settings.appearance.dayVisibility.hiddenDays.options.hideSunday'));
      dropdown.addOption('[6]', t('settings.appearance.dayVisibility.hiddenDays.options.hideSaturday'));
      dropdown.addOption('[1]', t('settings.appearance.dayVisibility.hiddenDays.options.hideMonday'));
      dropdown.addOption('[2]', t('settings.appearance.dayVisibility.hiddenDays.options.hideTuesday'));
      dropdown.addOption('[3]', t('settings.appearance.dayVisibility.hiddenDays.options.hideWednesday'));
      dropdown.addOption('[4]', t('settings.appearance.dayVisibility.hiddenDays.options.hideThursday'));
      dropdown.addOption('[5]', t('settings.appearance.dayVisibility.hiddenDays.options.hideFriday'));
