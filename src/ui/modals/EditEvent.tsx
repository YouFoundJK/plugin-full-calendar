    ...
    <div className="full-calendar-edit-modal">
      <form onSubmit={handleSubmit}>
        <div className="modal-header">
          <h2>{initialEvent?.title ? t('modals.editEvent.title.edit') : t('modals.editEvent.title.new')}</h2>
          {open && (
          ...
          <div className="setting-item">
            ...
            >
              ...
              >
                ...
                <option value="background">{t('modals.editEvent.fields.display.options.background')}</option>
                <option value="inverse-background">{t('modals.editEvent.fields.display.options.inverseBackground')}</option>
          ...
          <div className="setting-item-control options-group">
            ...
            {isTask && (
              <label
                title={
                  isRecurring
                    ? t('modals.editEvent.tooltips.recurringTaskCompletion')
                    : ''
                }
              >
                <input
            ...
            {enableReminders && (
              <label
                ...
                title={allDay || !endTime ? t('modals.editEvent.fields.options.endReminderTooltip') : ''}
              >
                <input
                  type="checkbox"
                  checked={endReminder}
        ...
        <div className="setting-item">
          ...
          <div className="setting-item-control">
            ...
            >
              ...
              <option value="monthly">{t('modals.editEvent.fields.repeats.options.monthly')}</option>
        ...
        {isRecurring && (
          <div className="setting-item">
            ...
            <div className="setting-item-control" style={{ alignItems: 'center', gap: '8px' }}>
              ...
              />
              <span>
                {recurrenceType === 'weekly' && (repeatInterval > 1 ? t('modals.editEvent.fields.repeats.weeks') : t('modals.editEvent.fields.repeats.week'))}
                {recurrenceType === 'monthly' && (repeatInterval > 1 ? t('modals.editEvent.fields.repeats.months') : t('modals.editEvent.fields.repeats.month'))}
                {recurrenceType === 'yearly' && (repeatInterval > 1 ? t('modals.editEvent.fields.repeats.years') : t('modals.editEvent.fields.repeats.year'))}
              </span>
            </div>
          </div>
        )}
        ...
        {isRecurring && (
          <>
            {recurrenceType === 'weekly' && (
              <div className="setting-item">
                <div className="setting-item-info">
                  <div className="setting-item-name">{t('modals.editEvent.fields.repeats.repeatOn')}</div>
                </div>
                <div className="setting-item-control">
                ...
                <div className="setting-item-control" style={{ display: 'block' }}>
                  ...
                  <div>
                    ...
                    <label htmlFor="monthly-day-of-month">
                      {' '}
                      {t('modals.editEvent.fields.repeats.onDay', { day: DateTime.fromISO(date).day })}
                    </label>
                  </div>
                  ...
                  >
                    ...
                    />
                    <label htmlFor="monthly-on-the">{t('modals.editEvent.fields.repeats.onThe')}</label>
                    <select
                      value={repeatOnWeek}
                      onChange={e => setRepeatOnWeek(parseInt(e.target.value, 10))}
                      disabled={monthlyMode !== 'onThe'}
                    >
                      <option value="1">{t('modals.editEvent.fields.repeats.ordinal.first')}</option>
                      <option value="2">{t('modals.editEvent.fields.repeats.ordinal.second')}</option>
                      <option value="3">{t('modals.editEvent.fields.repeats.ordinal.third')}</option>
                      <option value="4">{t('modals.editEvent.fields.repeats.ordinal.fourth')}</option>
                      <option value="-1">{t('modals.editEvent.fields.repeats.ordinal.last')}</option>
                    </select>
                    <select
            ...
            {recurrenceType === 'yearly' && date && (
              <div className="setting-item">
                <div className="setting-item-info"></div>
                <div className="setting-item-control">
                  {t('modals.editEvent.fields.repeats.yearlyText', { date: DateTime.fromISO(date).toFormat('MMMM d') })}
                </div>
              </div>
            )}
            ...
            <div className="setting-item">
              <div className="setting-item-info">
                <div className="setting-item-name">{t('modals.editEvent.fields.repeats.endRepeat')}</div>
              </div>
              <div className="setting-item-control">
                <input
                  type="date"
