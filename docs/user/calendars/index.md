...
| External calendar sync | [Google Calendar](gcal.md), [CalDAV](caldav.md), [ICS](ics.md) | Connect existing external schedules |
...
Remote/external: [ICS](ics.md), [CalDAV](caldav.md), [Google](gcal.md)  
Integrations: [Tasks](tasks-plugin-integration.md), [Bases](bases.md)
...
Compact index: [Full Note](local.md) · [Daily Note](dailynote.md) · [ICS](ics.md) · [CalDAV](caldav.md) · [Google](gcal.md) · [Tasks](tasks-plugin-integration.md) · [Bases](bases.md) · [Architecture](../../architecture/calendars/architecture.md)
