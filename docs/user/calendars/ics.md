...
> Since v0.12.7, you can also read `.ics` files stored directly in your Obsidian vault (Local ICS). The plugin will automatically detect if the calendar source is a remote URL or a local vault path. 
