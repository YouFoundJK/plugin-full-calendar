...
The latest version 0.13.1 introduces **[NLP](user/features/nlp.md) & [TaskNotes](user/calendars/tasknotes.md) integrations**, an achievements **[Milestones system](user/features/milestones.md)**, and **[Outlook Calendar sync](user/calendars/outlook.md)**! 

Recent updates include **[ActivityWatch sync](user/calendars/activitywatch.md)**, continuity-aware and expanded **[Tasks integrations](user/calendars/tasks-plugin-integration.md)**, **[Local ICS Support](user/calendars/ics.md)**, dramatically improved **[Staged Loading Architecture](./architecture/dev-logs/devlog_calendar_load_profiling_2026-04-11.md){: target="_blank" rel="noopener" }**, and completely rewritten **[Timezone & DST Hardening](user/events/timezones.md)** to ensure accurate events everywhere, alongside major recent releases that have brought incredible features like **[Full CalDAV Two-Way Sync](user/calendars/caldav.md)**, **[Mobile Workspaces & Monthly Views](user/views/workspaces.md)**, **[Multi-Language (i18n) Support](user/features/i18n.md)**, a deeply integrated **[Tasks Provider](user/calendars/tasks-plugin-integration.md)** with drag-and-drop backlog, and powerful additions like the **[Chrono Analyser dashboard](user/chrono_analyser/introduction.md)** and **[Advanced Categories system](user/events/categories.md)**.
...
![Sample Calendar](assets/guides/sample-calendar.png)
