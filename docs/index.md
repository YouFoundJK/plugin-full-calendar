...
The latest version 0.12.9 introduces **[ActivityWatch sync](user/calendars/activitywatch.md)**, continuity-aware and expanded **[Tasks integrations](user/calendars/tasks-plugin-integration.md)**. 
