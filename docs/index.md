...
The latest version 0.13.0 introduces **[NLP](user/features/nlp.md) & [TaskNotes](user/calendars/tasknotes.md) integrations**, an achievements **[Milestones system](user/features/milestones.md)**, and **[Outlook Calendar sync](user/calendars/outlook.md)**! 
