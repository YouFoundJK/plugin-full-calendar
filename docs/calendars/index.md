...
Compact index: [Full Note](local.md) · [Daily Note](dailynote.md) · [ICS](ics.md) · [CalDAV](caldav.md) · [Google](gcal.md) · [Tasks](tasks-plugin-integration.md) · [Bases](bases.md) · [Architecture](architecture.md)
